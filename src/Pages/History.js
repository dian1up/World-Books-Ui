...
import Cards from "../Component/CardsHistory";
          ...
          >
            <div className={classes.drawerHeader}>
              ...
              ?<div>{decode.level=='ADMIN'
                ...
                <ListItemText  style={{ textAlign:'center'}}  primary="Back" />
                </ListItem>
...
export default compose(withStyles(styles,{
  name:"Historys"
}),connect(mapStateToProps))(Historys)
// export default withStyles(styles)(Historys);